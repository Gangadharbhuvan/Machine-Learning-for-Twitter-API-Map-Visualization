...
def process(input_file, output_file):
    ...
    for tweet in tweets:
        ...
        cnt += 1
        if cnt % 100 == 0:
            print("Processed:", cnt, "(looked up:", locator.lookups, ")")
    ...
    # The mood is: 0.6359959009762148 (Java)
    # The mood is: 0.5781343859950228 (Python)


if __name__ == "__main__":
    input_file = r"tweets_with_python.json"    #specify the path to python json file
    output_file = "mood_data_python.csv"
    process(input_file, output_file)

    input_file = r"tweets_with_java.json"    #specify the path to java json file
